...
func getPopularMovieMockData() -> MovieResult? {
    var response: MovieResult?
    do {
        guard let data = popularMoviesMockResponse else {
...
var popularMovieMockData: MovieResult? = getPopularMovieMockData()
